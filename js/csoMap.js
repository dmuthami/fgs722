...
function init(){
    try{
        ...
        try{
            ...
            console.log("callCreatesearchDropDownWindow function = "+ ex);
        }
        finally{}				
    }
    catch(ex){
        console.log("csoMap:init = "+ ex);
    }
}
...
function callCreateMapsDropDownWindow(){
    try{		
        ...
        console.log("csoMap:callCreateMapsDropDownWindow = "+ ex);
    }
    finally {
...
function initiliazeMapVariables(){
    try{
        ...
        console.log("initiliazeMapVariables function = "+ ex);
    }
    finally{} 
}
...
function buildInnerHTML(){
    ...
    '</div>';
        ...
        console.log("buildInnerHTML function = "+ ex);
    }
    finally{ 
...
function getMapID(){
    try{
        ...
        console.log("csoMap:getMapID = "+ ex);
    }
}
...
var marginTop = 0;
var marginLeft = 0;
var mapWinSizeToPass = 0;
var hideDragContent = 'False';
var onMouseDownTriggerElement = "";
...
function animateCompleteCallBackFunction() {
    ...
    function(){
        ...
        function(){
            try{
                ...
                // above
                if (reset==1){
                    document.getElementById('dragContent1').style.display = "block"
                    };
            ...
            //$('#divContainer' + .id + '').click(animateCompleteCallBackFunction);
                ...
                console.log("Inner Animation function = "+ ex);
            }
            finally{}
    ...
    try{
        ...
        console.log("animateCompleteCallBackFunction function = "+ ex);
    }
    finally{}	
...
function constrainMapToMapWindow(yStart, xStart,componentWindow){
    try{
        ...
        console.log("constrainToMapWindow function = "+ ex);
    }
    finally{
...
function moveMapInTheXDirection(returnValue){
    try{
        ...
        console.log("moveMapInTheXDirection function = "+ ex);
    }
    finally{}  	
}
...
function moveMapInTheYDirection(returnValueY){
    try{
        ...
        console.log("moveInTheYDirection function = "+ ex);
    }
    finally{}  	
}
...
function setUp(){	
    try{
        ...
        console.log("displayMapUrl function = "+ ex);
    }
    finally{}
}
...
function legendButtonEvents() {
    try{
        ...
        console.log("LegendButtonEvents function = "+ ex);
    }
    finally{}
}
...
function changeInnerHTMLLegendDiv(){
    try{
        ...
        console.log("changeInnerHTMLLegendDiv function = "+ ex);
    }
    finally{}
}
...
function printMapEvents(){
    try{
        ...
        console.log("printMapEvents function = "+ ex);
    }
    finally{}
}
...
function printMapButtonEvents(){
    try{
        ...
        console.log("printMapButtonEvents function = "+ ex);
    }
    finally{}
}
...
function baseLayers() {
    ...
    console.log("baseLayers function = "+ ex);
}
finally{}
}
...
function divisionWMS(){
    try{
	   ...
	   */
        ...
        console.log("divisionWMS function = "+ ex);
    }
    finally{}
...
function locationWMS(){
    try{
	   ...
	   */
        ...
        console.log("locationWMS function = "+ ex);
    }
    finally{}
...
function subLocationWMS(){
    try{
	   ...
	   */
        ...
        console.log("subLocationWMS function = "+ ex);
    }
    finally{}
...
function provinceWMS(){
    try{
	   ...
	   */
        ...
        console.log("provinceWMS function = "+ ex);
    }
    finally{}
...
function removeAllWMSLayers(){
    try{
        ...
        console.log("removeAllWMSLayers function = "+ ex);
    }
    finally{}
}
...
function selectedLayersEvents(){
    try{		
        ...
        console.log("selectedLayersEvents function = "+ ex);
    }
    finally{}
}
...
function initializeMap(){
    try{
        ...
        console.log("InitializeMap function = "+ ex);
    }
    finally{}
}
